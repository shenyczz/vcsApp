...
namespace Hdwas
{
    ...
    public class CropGrowthPeriod : DependencyObject
    {
        ...
        /// <summary>
        /// 灌浆期标志 0=不是灌浆期 1=灌浆前期 2=灌浆中期 3=灌浆后期
        /// </summary>
        /// <param name="dateTime"></param>
        /// <returns></returns>
        public int GetFlag(DateTime dateTime)
        {
            return CropGrowthPeriod.GetFlag(this, dateTime);
        }
        public static int GetFlag(CropGrowthPeriod cropGrowthPeriod, DateTime dateTime)
        {
            ...
            try
            {
                ...
                // 开花期
                string s0 = cropGrowthPeriod.FloweringPeriod;
                string[] sa0 = s0.Split(new char[] { '月', '日' }, StringSplitOptions.RemoveEmptyEntries);
                int m0 = int.Parse(sa0[0]);
                int d0 = int.Parse(sa0[1]);
                DateTime dt0 = new DateTime(yy, m0, d0);
                ...
                DateTime dt1 = new DateTime(yy, m1, d1);
                ...
                DateTime dt2 = new DateTime(yy, m2, d2);
                ...
                DateTime dt3 = new DateTime(yy, m3, d3);

                if (dateTime > dt0 && dateTime <= dt1)
                    flag = 1;

                if (dateTime > dt1 && dateTime <= dt2)
                    flag = 2;

                if (dateTime > dt2 && dateTime <= dt3)
                    flag = 3;
            }
            catch
            {
